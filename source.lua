-- [[ COMPKILLER UI Engine - Core Source (Fixed Dragging & Added Minimize Button) ]]
local LunaCore = {}
...
function LunaCore:CreateWindow(configs)
    ...
    Title.Text = configs.Name or "COMPKILLER"
    ...
    -- 🚀 แก้ไขระบบลากหน้าต่าง (Smooth Drag System Fix)
    ...
    -- ปุ่มคีย์บอร์ดลัดเปิด/ปิด (ปุ่ม RightControl)
...
return LunaCore    TabHolder.Size = UDim2.new(1, -10, 1, -120)
    TabHolder.Position = UDim2.new(0, 5, 0, 50)
    TabHolder.BackgroundTransparency = 1
    TabHolder.BorderSizePixel = 0
    TabHolder.CanvasSize = UDim2.new(0, 0, 0, 0)
